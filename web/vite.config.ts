...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-msnfhmtw-wbdmsm-test",
        short_name: "Create Canary e2e-create-msnfhmtw-wbdmsm-test",
        description: "Create Canary e2e-create-msnfhmtw-wbdmsm-test — free forever",
        start_url: "/",
        display: "standalone",
